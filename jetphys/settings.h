...
string _jp_pudata = "pileup/PileUp_Profiles/RunB/pileup_DT.root";
...
string _jp_json = "pileup/JSON_ERA/Cert_272007-275376_13TeV_23Sep2016ReReco_Collisions16_JSON_eraB.txt";
...
string _jp_lumifile = "pileup/CSV_Files/brilcalc_lumibylsRunB.csv"; // Run II
...
//// 2016: //// // brilcalc lumi --hltpath "HLT_PFJet40_v*" -i [JSON]
      ...
      {40369.783, 963438.804, 6374455.72, 29747927.586, 131287524.515, 401206096.034, 1094110704.818, 5441258798.793}; //RunB

// Unprescaled luminosity for plots
const double _jp_lumi = 5.441258798793; // /fb from brilcalc for jt450 //36.810440678!
...
{ {272007,275376}}; // Spring/Summer16_23Sep2016
